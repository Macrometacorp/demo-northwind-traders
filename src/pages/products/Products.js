            ...
            {products.totalDocuments === 0 && (
                <Box>
                    ...
                    <OrderedList spacing={3} my={4}>
                        ...
                        <ListItem fontSize="lg">
                            Import the data from the "products.json" file located in the `ExtraFiles` folder in this project into
                            the newly created collection. Before you confirm make sure you select `ProductID` as the key.
                        </ListItem>
                        <ListItem fontSize="lg">
                        ...
                        <ListItem fontSize="lg">
                            Import categories.json and suppliers.json files located in the `ExtraFiles` folder in this project to the
                            created collections. Before you confirm make sure you select `CategoryID` as the key for categories and `SupplierID` as the key for suppliers.
                        </ListItem>
                        <ListItem fontSize="lg">
